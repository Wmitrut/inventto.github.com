...
ActiveRecord::Schema.define(:version => 20130315183235) do
  ...
  create_table "issue_numbers", :force => true do |t|
    t.integer "issue_id"
    t.integer "number"
  ...
  create_table "rates", :force => true do |t|
    ...
    t.integer "user_id"
    t.integer "project_id"
    t.date    "date_in_effect"
  end

  add_index "rates", ["date_in_effect"], :name => "index_rates_on_date_in_effect"
  add_index "rates", ["project_id"], :name => "index_rates_on_project_id"
  ...
  add_index "time_entries", ["rate_id"], :name => "index_time_entries_on_rate_id"
